...
export default function BilanContentBox(
    ...
    return (
        <div className='flex flex-col justify-between w-full h-full bg-cyan-950/70 p-2 rounded shadow-out'>
            
            <div className="flex flex-row items-center justify-center bg-gradient-to-bl from-slate-900 to-cyan-900 border-none px-2 py-1 rounded shadow-medium-darker">
