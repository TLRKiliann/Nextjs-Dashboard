...
export default function CartItemsQuantity() {
    ...
    return (
        <div className='absolute top-0'>
            <p className={`${storeQuantity === 0 ? "opacity-0" : "opacity-100"} flex items-center justify-center border-none w-[24px] h-[24px] text-xs
                text-slate-200 bg-blue-500 rounded-full mt-[20px] ml-[12px]`}>
                {storeQuantity}
            </p>
        </div>
    )
