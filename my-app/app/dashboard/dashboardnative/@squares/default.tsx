...
export default async function SquareDefault() {
    ...
    return (
        <div className='flex flex-row items-center justify-evenly w-full'>
            ...
            <div className='w-[21%] h-[80%] bg-green-200 rounded-lg shadow-md p-2 pt-3'>
            ...
            <div className='w-[21%] h-[80%] bg-orange-200 rounded-lg shadow-md p-2 pt-3'>
                <div className='flex flex-col items-center justify-around w-full h-full'>
            ...
            <div className='w-[21%] h-[80%] bg-cyan-200 rounded-lg shadow-md p-2 pt-3'>
                <div className='flex flex-col items-center justify-around w-full h-full'>
            ...
            <div className='w-[21%] h-[80%] bg-fuchsia-200 rounded-lg shadow-md p-2 pt-3'>
                <div className='flex flex-col items-center justify-around w-full h-full'>
